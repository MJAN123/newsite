        ...
        <div className={`fifthsection ${screen700?`h-[22rem]`:``} flex justify-end pr-20 mt-[-3.5rem] pb-20`}>  {/*pushing down*/}
            ...
            <div className={`mt-36 ${screen700?`w-full`:`w-[80%]`} ${screen700?`ml-20`:``} ${screen700?`mt-[3.5rem]`:``}`}>
                <di className="flex items-center ml-1 pb-7">
                    <div style={{ flex: "0.97" }}>
                        <button className={`w-[15.3rem] h-[2.3rem] ${screen700?`ml-[-1.5rem]`:`ml-[-0.5rem]`}`} onClick={() => {}}>
                    ...
                    <div className="flex items-center">
                        <button className={`w-full h-[2.3rem] ml-5 flex items-center ${screen240&&`ml-[-0.5rem]`}`} onClick={() => {}}>
                ...
                <div className={`flex ${screen700?`items-start`:`items-center`} ml-3 mt-10 ${screen700?`flex-col-reverse`:`flex-row`}`}>
                    ...
                    <div className={`flex justify-around ${screen700?`items-start`:`items-center`} ${screen700?`flex-col`:`flex-row`} w-[40%]`}>
                        <a href="https://google.com" className={`text-gray-400 ${screen380&&`w-[20rem]`}`}> Privacy Policy </a>
                        <a href="https://google.com" className={`text-gray-400 ${screen380&&`w-[20rem]`}`}> Terms & Conditions </a>
                        <a href="https://google.com" className={`text-gray-400 ${screen380&&`w-[20rem]`}`}> Legal </a>
                    </div>
                </div>
            </div>
        </div>
