    ...
    return (
        <div className="fourthsection pb-36">  {/*pushing down*/}
            ...
            <div className="flex justify-center items-center flex-col w-[37%]" style={{ margin: "0 auto" }}>
                <Typography className={`!text-4xl text-center !font-bold !tracking-wide !mt-36 ${!screen410?(screen700?`w-[35rem]`:`w-[32rem]`):`w-[21.95rem]`} fontFam`}> Get Started today! </Typography>  {/*pushing down*/}
